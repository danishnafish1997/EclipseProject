...
<header style="padding-top:10px"><b> XLSX TO CSV</b></header></div>
<p></p><br>
<div class="body"><br><h1 style="overflow: hidden; padding: 0px; margin-top: 50px;">XLSX to CSV</h1><table class="body" style="cellspacing:0;cellpadding:0; border:0; width:100%">
                    <tbody><tr>
                        <td width="294" valign="top">
                            <table class="body" style=" width:294 ; cellspacing:0;cellpadding:0 ;border:0">
                                <tbody><tr>
                                    <td>
                                        <br>
                                        Convert <b><i>XLSX to CSV</i></b> - <a  href="#tool">Convert your file now</a>-save the converted file into your local machine.
                        ...
                        <td>
                           <div class="blueBox">
                                <h2>How to convert a XLSX to a CSV file ?</h2>
                                <ol class="convert-ol">
                                    <li>Choose the XLSX file that you want to convert.</li>
                                    <li>Select the Destination Where you want to save the converted file</li>
                                    <li>Click "Convert" to Convert your XLSX file.</li>
                                 </ol>
                                </div>
                        </td>
                    </tr>
...
<form name="fileForm" id="fileForm" class="form"  action="ExcelToCsv" method="post">
    ...
    <div id="tabtable" class="conversionBox">
        <div id="steps" class="steps clearfix">
            <div class="step1" style="font-size: 13px; font-family: Tahoma,sans-serif; float: left; padding-right: 10px; padding-top: 15px; width: 190px;">
                 <h3>Step 1</h3>Enter the <a href="/url/">URL</a>of File you <br> wish to convert ...                <p></p><table style="cellpadding:0; cellspacing:0; border:0">
                  <tbody><tr>
                    <td id="fileInputElementParent">
                     <input id="inputFile" class="bodyBig" type="text" name="t3" size="12">
                    </td>
                  </tr>
                  </tbody></table><p></p>
            </div> 
            <div class="step2"><h2>Step 2</h2>Enter the URL Where you<br> wish to Save<p><input type ="text" name="t4" > </div>
            <div class="step2" style="font-size: 13px; font-family: Tahoma,sans-serif;">
                <h3>Step 4</h3>Convert your file now <p><input id="uploadButton" type="submit" class="bodyBig" value="Convert"></p></div><div id="dnd-target" class="dnd-display">Drop your files here</div>            
        </div>
</div>
</form>      </div><br><br>
