...
<header style="padding-top:10px"><b> Save XLSX File To Database</b></header></div>
<p></p><br>
<div class="body"><br><h1 style="overflow: hidden; padding: 0px; margin-top: 50px;">XLSX to CSV</h1><table class="body" style="cellspacing:0;cellpadding:0; border:0; width:100%">
                    <tbody><tr>
                        <td width="294" valign="top">
                            <table class="body" style=" width:294 ; cellspacing:0;cellpadding:0 ;border:0">
                                <tbody><tr>
                                    <td>
                                        <br>
                                         You<b><i> are one step away to</i></b> - <a  href="#tool">Save </a>  -  Your XLSX file into database.
                        ...
                        <td>
                           <div class="blueBox">
                                <h2>How to Save Your XLSX file to Database ?</h2>
                                <ol class="convert-ol">
                                    <li>Choose the XLSX file that you want to save.</li>
                                    <li>Click "Save" to Save your XLSX file.</li>
                                 </ol>
                                </div>
                        </td>
                    </tr>
...
<form name="fileForm" id="fileForm" class="form"  action="ReadServlet" method="post">
    ...
    <div id="tabtable" class="conversionBox">
        <div id="steps" class="steps clearfix">
            <div class="step1" style="font-size: 13px; font-family: Tahoma,sans-serif; float: left; padding-right: 100px; padding-top: 15px;padding-left:30px width: 190px;">
                 <h3>Step 1</h3>Enter the <a href="/url/">URL</a>of File you <br> wish to Save ...                <p></p><table style="cellpadding:0; cellspacing:0; border:0">
                  <tbody><tr>
                    <td id="fileInputElementParent">
                     <input id="inputFile" class="bodyBig" type="text" name="t1" size="15">
                    </td>
                  </tr>
                  </tbody></table><p></p>
            </div> 
            <div class="step2" style="font-size: 13px; font-family: Tahoma,sans-serif;paddding-left:100px;padding-right:100px">
                <h3>Step 2</h3>Save Your file now <p><input id="uploadButton" type="submit" class="bodyBig" value="Save"></p></div><div id="dnd-target" class="dnd-display">Drop your files here</div>            
        </div>
</div>
</form>      </div>
      </div><br><br>
